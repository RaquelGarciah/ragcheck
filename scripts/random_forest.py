"""Entrena y evalúa el bosque aleatorio sobre RAGTruth.

Carga los datos, extrae features, valida con GroupKFold por `source`, calcula
las métricas A–F y guarda informe y figuras (incluida la importancia de
variables).
"""
...
def main() -> None:
    # Fase 0: load_ragtruth -> extract_features -> cross_validate(build_random_forest())
